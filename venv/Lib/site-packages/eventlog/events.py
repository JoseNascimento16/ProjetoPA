...
class EventGroup(object):
    ...
    def _log_event(self, type, message, initiator=None, plano_base=0, send_mail=None):
        """
        Log a new event entry.
        """
        EventModel = apps.get_model('eventlog', 'Event')
        event_object = EventModel.objects.create(
            type=type, group=self.group_id, message=message, initiator=initiator, plano_base=plano_base)
