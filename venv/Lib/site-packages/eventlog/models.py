...
class Event(models.Model):
    ...
    plano_base = models.IntegerField(_('Plano base'), default=0)
    plano_situacao_log = models.CharField(_('Situação log'), max_length=50, blank=True, null=True)
