...
urlpatterns = [
    ...
    path('planos_de_acao/concluidos',views.planos_finalizados, name='pagina_planos_finalizados'),
    ...
    path('pesquisa/plano',views.pesquisa_plano, name='pesquisar_plano'),
    path('planos_de_acao/<slug:search>/pesquisa',views.planos_de_acao, name='pagina_planos_de_acao_pesquisa'),
    

    # path('test/<int:elemento_id>',views.teste, name='test_plano'),
    ...
    # path('plano/<int:plano_id>/<slug:gera_ordem>/<int:ordem_id>/edita/<slug:edita_ordem>',views.plano, name='abrindo_edicao_ordem'),
