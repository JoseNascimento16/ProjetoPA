...
urlpatterns = [
    ...
    path('plano/<int:plano_id>/cria_correcao/<int:ordem_fia_id>/fia',views.cria_altera_correcao_fia, name='chamando_cria_altera_correcao_fia'),
    path('plano/<int:plano_id>/fia/deleta_correcao/<int:ordem_fia_id>/slug/<slug:tipo_ordem>',views.deleta_correcao_fia, name='chamando_deleta_correcao_fia'),
    path('abre_correcao/fia/<int:elemento_id>/acao/<int:ident_numerica>',views.abre_correcao_fia, name='abrindo_correcao_fia'),
